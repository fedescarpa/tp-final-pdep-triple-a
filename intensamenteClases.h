...
// <--Cambiado unPrimerRecuerdo por PensamientosDelDia -->
...
void vivi_un_evento (NENA * , RECUERDO * );
...
bool ordenar_recuerdos_porfecha_ascendente(void * , void * );
bool ordenar_recuerdos_porfecha_descendente(void * , void * );
